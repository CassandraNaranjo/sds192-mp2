...
These data graphics can tell us how likely a candidate who is already in office would be to win again in their respective state and whether or not that differs between democrats and republicians.
=======
```
>>>>>>> 5740a925be44eafc23f54bc5e22688aa1ba56c3c
...
We used used a plot function to create the graphics for California, New York, and Texas. The x-axis is displaying the political parties, democratic and republican, whereas the y-axis is displaying the number of incumbent candidates. The key on the righthandside displays the combinations of conditions this data graphic is displaying along with the colors that represent them. We also used an annotation feature to display the percentages of the winners for each party in each state data graphic to make the graphic easier to understand.
```{r}
...
```
**Results: This plot tells us that there are more incumbent democratic candidates in California and that these incumbent candidates were also more likely to be re-elected in the general election compared to republican incumbent candidates. Incumbent democratic candidates were 87% likely to be re-elected whereas Republican imcumbent candidates were 80% likely.**
...
```
**Results: This plot tells us that are more incumbent republican candidates in Texas and that these incumbent candidates were more likely to be re-elected in the general election compared to democratic incumbent candidates. Incumbent republican candidates were 95% likely to be re-elected whereas Democratic imcumbent candidates were only 88% likely.**

**General Results: When looking at all of these plots in unison, it is very clear that regardless of party, incumbent candidates were very likely to be re-elected in 2012. Therefore, one can conclude that they have a better chance of keeping their seat compared to someone else who running for their seat.**
